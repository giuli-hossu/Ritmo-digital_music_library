...
function Description() {
  return (
    <section id="description" className="row">
      {/* First article containing the main description text */}
      <article className="col-lg-6 col-sm-12 description-article">
        ...
        <p>
          ...
          Relive cherished moments with the songs that defined them.
        </p>
      </article>

      {/* Second article containing an embedded object for visual representation */}
      <article className="col-lg-6 col-sm-12 article-triangle">
        <object
          className="triangle-article"
          data="https://rive.app/community/files/892-1747-music-listener-musiclistener/embed">
        </object>
      </article>
    </section>
  );
